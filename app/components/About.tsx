    ...
    >
      ...
      <div className="reveal d1 mx-auto mt-8 max-w-2xl space-y-5 text-left text-lg leading-relaxed text-ink/75">
        <p>
          ...
          should reflect who you are, not who you feel pressured to pretend to
          be. That belief is the heart of everything I teach.
        </p>
        <p>
          ...
          alignment, and body awareness. After a dance injury abruptly paused my
          career, Pilates became an essential part of my recovery, helping me
          rebuild strength, restore trust in my body, and reconnect to movement
          in a new way. That relationship deepened again through prenatal and
          postpartum recovery, showing me firsthand how movement can support us
          through life&apos;s many seasons. It taught me what I now build my
